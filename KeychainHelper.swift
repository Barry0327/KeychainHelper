...
//
//  Created by Barry Chen on 2019/10/5.
...
public enum KeychainKeys: String {
    case accessToken, appleUserID, anonymous, queryHistories, lastLoginAccount ,member
}
...
public struct KeychainHelper {
    ...
    public func readInfoForBiometryLogin() throws -> Credentials {
        let query: [String: Any] = [kSecClass as String: kSecClassInternetPassword,
                                    kSecAttrServer as String: service,
    ...
    public func deleteBiometryInfo() throws {
        let query: [String: Any] = [kSecClass as String: kSecClassInternetPassword,
                                    kSecAttrServer as String: service]
